...
with conn:
	...
	for i in range(1,rows):
		try:
			#sql = "insert into mip_articles (id,uuid,cid,uid,title,views,create_time,edit_time,is_recommend,comments,version,publish_time,collect,mip_post_num,content_id,url_name,img_url,keywords,link_tags,description,site_id,mip_push_num,amp_push_num,xzh_push_num,link_push_num,yc_push_num,baidu_spider_num,google_spider_num,so_spider_num,sm_spider_num,sogou_spider_num,baidu_spider_time,google_spider_time,so_spider_time,sm_spider_time,sogou_spider_time) 
			#values('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s')" 
			#%(t1.row_values(i)[0],t1.row_values(i)[1],t1.row_values(i)[2],t1.row_values(i)[3],t1.row_values(i)[4],t1.row_values(i)[5],t1.row_values(i)[6],t1.row_values(i)[7],t1.row_values(i)[8],t1.row_values(i)[9],t1.row_values(i)[10],t1.row_values(i)[11],t1.row_values(i)[12],t1.row_values(i)[13],t1.row_values(i)[14],t1.row_values(i)[15],t1.row_values(i)[16],t1.row_values(i)[17],t1.row_values(i)[18],t1.row_values(i)[19],t1.row_values(i)[20],t1.row_values(i)[21],t1.row_values(i)[22],t1.row_values(i)[23],t1.row_values(i)[24],t1.row_values(i)[25],t1.row_values(i)[26],t1.row_values(i)[27],t1.row_values(i)[28],t1.row_values(i)[29],t1.row_values(i)[30],t1.row_values(i)[31],t1.row_values(i)[32],t1.row_values(i)[33],t1.row_values(i)[34],t1.row_values(i)[35])#要执行sql语句
			
			sql ="insert into mip_articles\
			(id,typeid,typeid2,sortrank,flag,ismake,channel,arcrank,click,money,title,shorttitle,color,writer,source,litpic,pubdate,senddate,mid,keywords,lastpost,scores,goodpost,badpost,voteid,notpost,description,filename,dutyadmin,tackid,mtype,weight)\
			values('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s',)"%(t1.row_values(i)[0],t1.row_values(i)[1],t1.row_values(i)[2],t1.row_values(i)[3],t1.row_values(i)[4],t1.row_values(i)[5],t1.row_values(i)[6],t1.row_values(i)[7],t1.row_values(i)[8],t1.row_values(i)[9],t1.row_values(i)[10],t1.row_values(i)[11],t1.row_values(i)[12],t1.row_values(i)[13],t1.row_values(i)[14],t1.row_values(i)[15],t1.row_values(i)[16],t1.row_values(i)[17],t1.row_values(i)[18],t1.row_values(i)[19],t1.row_values(i)[20],t1.row_values(i)[21],t1.row_values(i)[22],	t1.row_values(i)[23],t1.row_values(i)[24],t1.row_values(i)[25],t1.row_values(i)[26],t1.row_values(i)[27],t1.row_values(i)[28],t1.row_values(i)[29],t1.row_values(i)[30],t1.row_values(i)[31],)
			cur.execute(sql)#执行
			conn.commit()#提交
		except Exception,e:
			print e
